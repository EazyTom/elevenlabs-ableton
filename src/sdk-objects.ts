import { AudioTrack, ClipSlot, MidiTrack, Track } from "@ableton-extensions/sdk";
...
export function isMidiTrack(obj: unknown): obj is MidiTrack<"1.0.0"> {
  return obj instanceof MidiTrack || sdkClassName(obj) === MidiTrack.className;
}
